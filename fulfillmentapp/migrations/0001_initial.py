# Generated by Django 4.2.7 on 2023-12-09 21:23
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('article', models.CharField(default=None, max_length=30, verbose_name='Артикль с маркетплейса')),
                ...
                ('weight', models.IntegerField(default=1000, verbose_name='Вес (г.)')),
                ('price', models.IntegerField(default=0, verbose_name='Цена (руб.)')),
                ('seller', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='products', to='fulfillmentapp.seller', verbose_name='Продавец')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='products', to='fulfillmentapp.delivery', verbose_name='Отгрузка')),
